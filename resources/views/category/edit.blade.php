            ...
            <div class="bg-blue-900 overflow-hidden shadow-2xl sm:rounded-xl border border-blue-800">
                <div class="p-8 text-gray-100">
                    ...
                    <div class="mb-8">
                        ...
                        <p class="text-sm text-blue-200 mt-1 ml-7">Update category details</p>
                    </div>
                    ...
                    <form action="{{ route('category.update', $category->id) }}" method="POST">
                        ...
                        <div class="mb-8">
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name', $category->name) }}" class="w-full bg-blue-950 border border-blue-800 rounded-lg text-white shadow-sm focus:border-indigo-500 focus:ring-indigo-500 py-2.5 px-3 placeholder-blue-400" required>
                        </div>
                        ...
                        <div class="flex justify-end gap-3 pt-4 border-t border-blue-800 mt-6">
                            ...
                            <button type="submit" class="bg-indigo-600 hover:bg-indigo-500 text-white font-medium py-2 px-6 rounded-lg transition duration-200 ease-in-out shadow-lg shadow-indigo-500/30 text-sm">Update Category</button>
                        </div>
                    </form>
